...
const EVENTS_MANAGER_PATH: String = "res://addons/homero_framework/src/core/components/events/events_manager.gd"
...
func _enter_tree() -> void:
	...
	add_autoload_singleton("EventsManager", EVENTS_MANAGER_PATH)
...
func _exit_tree() -> void:
	...
	remove_autoload_singleton("EventsManager")
